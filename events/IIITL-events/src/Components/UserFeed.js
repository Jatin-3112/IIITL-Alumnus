...
const UserFeed = () => {
    ...
    return (
        ...
        <Header/>
            <div className='grid grid-flow-row grid-cols-3 w-2/3  m-auto translate-y-[100px]  '>
                <div className='my-2 w-[300px] bg-white shadow-lg rounded-lg h-fit mx-10 '>
                    <img className='w-full h-[100px]' src="https://marketplace.canva.com/EAEmBit3KfU/1/0/1600w/canva-black-flatlay-photo-motivational-finance-quote-facebook-cover-myVl9DXwcjQ.jpg" alt="" />
                    <div>
                        <img className='rounded-full h-20 w-20 m-auto border-[2px] border-blue-500 translate-y-[-30px]' src={sessionStorage.getItem("imageUrl")} alt="" />
                        <h2 className='text-center text-xl font-semibold my-3'> {sessionStorage.getItem('fName') +" "+sessionStorage.getItem('lName')} </h2>
                        <p className="mb-4 text-sm mx-5 leading-relaxed text-blueGray-700">
                            4⭐️ @Codechef |specialist Codeforeces | Web Developer |MERN NEXTJS | WebDev Member @AxiosIIITL | sophomore @IIIT Lucknow
                        </p>
